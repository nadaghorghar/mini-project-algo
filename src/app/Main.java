            ...
            switch (choice) {
                ...
                case 2: // Validation morphologique
                    ...
                    if (valResult.isValid()) {
                        ...
                        System.out.println("   Schème utilisé: " + valResult.getScheme().getName() +
                                " (" + valResult.getScheme().getPattern() + ")");
                ...
                case 3: // Générer toute la famille morphologique
                ...
                case 4: // Afficher dérivés validés d'une racine
                    System.out.print("Racine: ");
                ...
                case 5: // Ajouter une nouvelle racine
                    System.out.print("Nouvelle racine (3 lettres): ");
                ...
                case 6: // Ajouter un nouveau schème
                    System.out.print("Nom du schème (ex: فاعل): ");
                    String schemeName = sc.nextLine();
                    System.out.print("Pattern (ex: ف1ا ف2 ف3): ");
                    String schemePattern = sc.nextLine();

                    schemes.insert(new Scheme(schemeName, schemePattern));
                    System.out.println("✅ Schème ajouté avec succès");
                    break;

                case 7: // Afficher toutes les racines
                    System.out.println("\n=== RACINES DISPONIBLES ===");
                    tree.displayInOrder();
                    break;

                case 8: // Afficher tous les schèmes
                    System.out.println("\n=== SCHÈMES DISPONIBLES ===");
                    schemes.displayAll();
                    break;
