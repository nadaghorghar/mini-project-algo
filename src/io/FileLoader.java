...
public class FileLoader {
    ...
    public static void loadRoots(String filename, AVLTree tree) {
        ...
        if (!file.exists()) {
            System.err.println("⚠️  Fichier non trouvé: " + filename);
        ...
        try (BufferedReader br = new BufferedReader(
            ...
            while ((line = br.readLine()) != null) {
                ...
                root.detectType(); // Méthode à ajouter dans Root.java
                tree.insert(root);
                count++;
            }
     ...
     * Format: nom|pattern (ex: فاعل|ف1ا ف2 ف3)
     */
        ...
        try (BufferedReader br = new BufferedReader(
            ...
            while ((line = br.readLine()) != null) {
                ...
                if (parts.length == 2) {
                    ...
                    System.err.println("⚠️  Ligne invalide ignorée: " + line);
                }
            }
